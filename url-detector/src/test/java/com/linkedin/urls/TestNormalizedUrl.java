...
class TestNormalizedUrl {
  ...
  void testUsernamePasswordUrls(String testString, String host, String path) throws MalformedURLException {
  ...
  /**
   * <a href="https://developers.google.com/safe-browsing/developers_guide_v3#Canonicalization">Canonicalization</a>
   */
  @ParameterizedTest
  @CsvSource({
  ...
  void testFullUrls(String host, String expectedHost) throws MalformedURLException {
